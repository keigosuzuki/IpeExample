...
```text
IpeExample/
├── docs/            # Ipe 入門・活用ガイド，解説図版，デモファイル
│   ├── GUIDE.md               # Ipe 入門・活用ガイド
│   ├── fig/                   # ガイド用解説図版
│   └── demo/                  # 機能デモ・作例（動画埋め込み, プロット連携）
...
│   ├── plot_import.lua        # ベクター図インポート (MATLAB / Python等) & パレット適用
...
└── templates/       # 発表用テンプレート (.ipe, .pdf)
    ├── template_slide_suzuki_16_9.ipe  # 16:9 スライドテンプレート
